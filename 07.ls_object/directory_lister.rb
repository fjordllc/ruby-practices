...
class DirectoryLister
  ...
  def list_directory
    ...
    if @options[:long_format]
      ...
      partitioned_files = partition_filenames(file_names)
  ...
  def partition_filenames(files)
    rows = (files.length / MAX_COLUMNS.to_f).ceil
...
directory_lister = DirectoryLister.new(options)
directory_lister.list_directory
